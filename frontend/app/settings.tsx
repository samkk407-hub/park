...
import {
  Platform, ScrollView, StyleSheet, Switch, Text, TouchableOpacity, View, useColorScheme
} from "react-native";
  ...
  const SettingRow = ({
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        {subtitle && <Text style={[styles.settingSub, { color: colors.mutedForeground }]}>{subtitle}</Text>}
      </View>
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <View style={[styles.group, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <SettingRow icon="phone" label="Mobile" value={`+91 ${user?.mobile}`} />
        ...
        <View style={[styles.group, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <SettingRow icon="zap" label="Bike Rate" value={parking ? `₹${parking.bikeRate}/hr` : "—"} />
          <SettingRow icon="truck" label="Car Rate" value={parking ? `₹${parking.carRate}/hr` : "—"} />
        ...
        <View style={[styles.group, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <SettingRow icon="sun" label="Theme" value={colorScheme === "dark" ? "Dark" : "Light"} subtitle="Follows system setting" />
          <SettingRow icon="globe" label="Currency" value="₹ INR" />
